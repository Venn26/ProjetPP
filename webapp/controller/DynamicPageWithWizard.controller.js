sap.ui.define([
    ...
    return Controller.extend("wwl.controller.DynamicPageWithWizard", {
        onInit: function () {
        ...
        calcTotal: function () {
            let data = this.model.getData().ProductCollection;
            if (data) {
        ...
        handleDelete: function (listItemBase) {
            let listItem = listItemBase.mParameters.listItem;
            let data = this.model.getData().ProductCollection;
            if (data.length <= 1) {
                return;
            }
        ...
        goToPaymentStep: function () {
            let selectedKey = this.model.getProperty("/selectedPayment");
        ...
        checkCreditCardStep: function () {
            let cardName = this.model.getProperty("/CreditCard/Name") || "";
        ...
        checkCashOnDeliveryStep: function () {
            let firstName = this.model.getProperty("/CashOnDelivery/FirstName") || "";
